...
from getImages import prepare_string
...
def train_lda():
    ...
    html = urllib.request.urlopen('https://www.biblegateway.com/passage/?search=Revelation+11&version=KJV').read()
    ...
    for topic in topicList: 
        topic = "bible revelation" + topic
        downloadimages(topic)  
        print()
